...
export default function CartSummary({
  ...
  return (
    <div className="h-full flex flex-col p-6">
      ...
      {/* Cart Items - Fixed scrollable area */}
        ...
        <div className="space-y-3">
          ...
          {onHoldSale && (
            <button
              ...
              className="w-full py-2.5 px-4 border border-gray-300 text-gray-700 bg-white rounded-lg font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
            >
          ...
          <button
            ...
            className="w-full text-white py-3 px-4 rounded-lg font-medium hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-all"
