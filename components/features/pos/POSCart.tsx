      ...
      <div className="flex-1 overflow-y-auto">
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full p-6 text-gray-500">
            ...
            <p className="text-center">Add products to start a sale</p>
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <input
                      ...
                      className="w-16 text-center font-medium py-1 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
        ...
        <div className="border-t border-gray-200 p-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-4 text-white font-bold text-lg rounded-lg hover:opacity-90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
